...
```shell
docker pull imodstyle/chromium
```
...
container image.
  ...
  3.  In the search bar, type the name of the container (`imodstyle/chromium`).
...
To properly work, recent versions of Chromium need the
...
If Chromium is crashing frequently, make sure that:
